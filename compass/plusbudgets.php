...
<head>
	...
	<title>Bizning qarzdorlik ko'rsatgichimiz</title>
	<!-- Bu yerda scriptlar -->
...
<h2>Compassning qarzdorlik ko'rsatgichi</h2><br>
<table class="table table-bordered table-striped datatable" id="table-4">
	...
	<tbody>
		<?php 
			$n = 0;
			$query = "SELECT * FROM buyers WHERE buyers_budget > 0 ORDER BY buyers_budget DESC";
		...
		<tr class="odd gradeX">
			...
			<td><span class="badge badge-success"><?php echo number_format($buyers_budget); ?></span></td>
...
<!-- Footercha -->
		<br />
		<footer class="main">
			&copy; 2019 <strong>Compass Group</strong> All Rights Reserved
		</footer>
	</div>
</div>
<!-- /Footercha -->
